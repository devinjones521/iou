...
// No default: this is the operator's own ssh alias and has no business shipping in a public repo.
const SSH_HOST = process.env.IOU_SSH_HOST;
if (!SSH_HOST) throw new Error("IOU_SSH_HOST must be set to the ssh alias of the deployment host");
